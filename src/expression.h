...
// TODO?: rename adj and adjdiff -> adjdiff, adjdiff2
struct Adjacency {
...
public:
    explicit ParamExpression(ParamAdjacency adj, ParamAdjacencyDiff adjDiff) : adj{std::move(adj)},
                                                                               adjDiff{std::move(adjDiff)}  {}
