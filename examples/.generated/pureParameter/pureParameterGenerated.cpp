...
public:
	...
	double eval(const double *x, const double *u, const double *p, double t) override {
		return -(1.35254653250277*p[0] + 0.381489756430632*p[10] + 0.696151464228967*p[11] + 1.73280928003982*p[1] + 1.29922224580881*p[2] + 0.901005937488807*p[3] + 1.52589641124079*p[4] + 1.99171962482179*p[5] + 0.387873385562095*p[6] + 1.03348502447369*p[7] + 1.77149587229541*p[8] + 0.961216796843392*p[9]);
	}

	std::array<std::vector<double>, 3> evalDiff(const double *x, const double *u, const double *p, double t) override {
		return {std::vector<double>{}, {}, {-1.35254653250277, -1.73280928003982, -1.29922224580881, -0.901005937488807, -1.52589641124079, -1.99171962482179, -0.387873385562095, -1.03348502447369, -1.77149587229541, -0.961216796843392, -0.381489756430632, -0.696151464228967}};
	}
...
public:
	...
	double eval(const double* p) override {
		return 0.046117027298721*p[0] + 0.686187292391391*p[10] + 1.94538850863051*p[11] + 1.33064368803508*p[1] + 1.49294406263555*p[2] + 1.53057092494927*p[3] + 1.33646313848487*p[4] + 1.4040454813048*p[5] + 1.01644144303651*p[6] + 1.80837434142314*p[7] + 0.403877094755075*p[8] + 0.120575433479862*p[9];
	}

	std::vector<double> evalDiff(const double* p) override {
		return std::vector<double>{0.046117027298721, 1.33064368803508, 1.49294406263555, 1.53057092494927, 1.33646313848487, 1.4040454813048, 1.01644144303651, 1.80837434142314, 0.403877094755075, 0.120575433479862, 0.686187292391391, 1.94538850863051};
	}
