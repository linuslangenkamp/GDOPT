...
model.plot(specifCols=None, meshIteration=None, interval=None, dots=Dots.OFF):      
	...
	\begin{itemize}
		...
		\item \texttt{Dots dots} \emph{(optional)}: Adds dots of the discrete solution to the plot. This has to be an element of \ref{enum:Dots} and in the default case no dots are added.
	\end{itemize}
